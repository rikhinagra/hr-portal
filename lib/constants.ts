...
Harassment, bullying, discrimination, verbal abuse, or any form of intimidation is not tolerated. This includes written communication. Violations fall under our Zero Tolerance Policy (Chapter 16).`,
  ...
  {
    num: 9,
    title: 'Appearance & Virtual Presence',
    content: `We do not enforce a formal dress code. However, as professionals who regularly join virtual calls with clients and stakeholders, we expect you to look the part.
...
All appraisal data is shared only between the employee, their manager, HR, and management. No discussions in open channels or with peers.`,
  },
  {
    ...
    content: `Laptop Specs: Laptop specs are defined by the Team Lead during the hiring process.

Day 1 Configuration: All equipment is configured by IT with required software, VPN, and security tools on Day 1.

Asset Tracking: An asset tracking form must be signed upon handover of any company equipment.

Your Responsibility: You are responsible for the care, maintenance, and security of all assigned equipment. Report damage, loss, or malfunction to IT and HR immediately.

Upon Separation: All equipment must be returned, inspected, and wiped upon separation from the company.

Company equipment is for professional use only. Unauthorized software installation, disabling security tools, or personal misuse is strictly prohibited.`,
  },
  {
    num: 14,
...
All client data shared with Aadhcode is governed by our NDA and data processing agreements. Treat every piece of client data as if it were your own personal financial information.`,
  },
  {
    ...
    content: `We want every team member to feel safe, heard, and supported. Clear channels are available for any issue.

For Work-Related Issues: Speak directly with your Team Lead. For Interpersonal or Behavioural Issues: Email hrdesk@aadhcode.com. For Sensitive Matters: Request a confidential meeting with HR or the Operations Manager.
...
Your acknowledgement is recorded digitally with the date and time. A confirmation is sent to HR and stored in your employee record.

Contact HR at hrdesk@aadhcode.com for any questions about this handbook or its contents.

Thank you for taking the time to read and understand these policies. Welcome to the team.`,
  },
];

export const POLICIES_LIST = [
  { name: 'Employee Onboarding Checklist', category: 'Onboarding', file: 'Employee_Onboarding_Checklist.pdf' },
  { name: 'Hiring Requirement Collection Document', category: 'Recruitment', file: 'Hiring_Requirement_Collection_Document.pdf' },
  { name: 'Leave Application Policy', category: 'Leave', file: 'Leave_Application_Policy.pdf' },
  { name: 'Work From Home Policy', category: 'WFH', file: 'WORK_FROM_HOME_POLICY.pdf' },
  { name: 'Employee Handbook v1.0', category: 'Handbook', file: 'EMPLOYEE_HANDBOOK.pdf' },
  { name: 'Data Security & Confidentiality Policy', category: 'Security', file: 'Data_Security_Policy.pdf' },
  { name: 'Zero Tolerance Policy', category: 'Conduct', file: 'Zero_Tolerance_Policy.pdf' },
];
